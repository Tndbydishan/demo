        ...
        <div className={`${styles['comm-google-section']} comm-google-section`}>
          ...
          <div className={styles['comm-google-card']}>
            ...
            <div className={styles['comm-g-actions']}>
              <a href="https://g.page/r/CeXq8Oy5vR-OEAI/review" target="_blank" rel="noreferrer" className={`${styles['comm-g-btn']} ${styles['review']}`}>
                Write a Review
              </a>
              <a href="https://maps.app.goo.gl/CmNWbNZQXdVTA4cc6" target="_blank" rel="noreferrer" className={`${styles['comm-g-btn']} ${styles['follow']}`}>
                Follow
              </a>
            </div>
          </div>
